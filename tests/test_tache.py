...
class TestTache(unittest.TestCase):
    ...
    def test_creation_with_only_title(self):
        ...
        self.assertIsNone(tache1.description, "La description par défaut devrait être None")
        self.assertIsNone(tache1.date_limite, "La date limite par défaut devrait être None")
    ...
    def test_to_dict_from_dict(self):
        ...
        self.assertEqual(d, expected, "La conversion en dictionnaire ne fonctionne pas comme prévu")
        ...
        self.assertEqual(tache2.get_description(), "Test description", "Erreur sur la description reconstruit")
        self.assertEqual(tache2.get_priorite(), 5, "Erreur sur la priorité reconstruit")
        self.assertEqual(tache2.get_date_limite(), "2025-01-01", "Erreur sur la date limite reconstruit")
    ...
    def test_str_representation(self):
        ...
        rep = str(tache1)
        self.assertIn("Tâche ID: 654321", rep, "La représentation en chaîne ne contient pas l'ID")
        self.assertIn("Titre: Faire les courses", rep, "La représentation en chaîne ne contient pas le titre")
    ...
    def test_generate_unique_id(self):
        ...
        self.assertNotIn(new_id, {111111, 222222}, "L'ID généré doit être unique par rapport aux tâches existantes")
        self.assertTrue(100000 <= new_id <= 999999, "L'ID doit être un nombre à 6 chiffres")
        
        # Test de génération avec une liste vide
        tasks = []
        new_id = generate_unique_id(tasks)
        self.assertTrue(100000 <= new_id <= 999999, "L'ID doit être un nombre à 6 chiffres pour une liste vide")
